...
2. Navegá al detalle de REIT en IEB Mas, Balanz, IOL, PPI o Cocos Capital (en Cocos, seleccioná REIT en el mercado para abrir el panel lateral).
...
└── src/
    ...
    ├── brokers.js      # Adaptadores por ALyC (IEB Mas, Balanz, IOL, PPI, Cocos)
